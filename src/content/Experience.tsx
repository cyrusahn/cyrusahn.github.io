...
interface Experience {
  ...
  desc: string[];
  bgColor: string;
  logo: JSX.Element; // Type the logo as JSX.Element
}

// Declare JSX elements for logos
const peroptyxLogo = <img src="peroptyx.png" alt="Peroptyx Logo" />;
const evidencebancLogo = <img src="evidencebanc.png" alt="EvidenceBanc Logo" />;
const phsaLogo = <img src="phsa.png" alt="PHSA Logo" />;
...
export const experience: Experience[] = [
  {
    ...
    bgColor: "#50659F",
    logo: peroptyxLogo, // Reference JSX element
  },
  {
    ...
    bgColor: "#B9C8E5",
    logo: evidencebancLogo, // Reference JSX element
  },
  {
    ...
    bgColor: "#9397B1",
    logo: phsaLogo, // Reference JSX element
  }
];
